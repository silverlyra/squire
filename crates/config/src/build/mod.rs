...
//!
//! Each option Squire recognizes is represented as a [`Directive`].
//!
...
/// [compile]: https://sqlite.org/compile.html
pub trait Directive:
    Sealed + Copy + From<Self::Value> + fmt::Debug + fmt::Display + PartialEq
{
